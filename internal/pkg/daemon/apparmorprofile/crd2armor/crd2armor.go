...
profile {{.Name}} {{.Binary}} flags=({{.ProfileMode}},attach_disconnected,mediate_deleted) {
...
func GenerateProfile(name string, binary string, complainMode bool,
	abstract *apparmorprofileapi.AppArmorAbstract) (string, error) {
